...
func ValidatePasswordPlaintext(v *validator.Validator, plaintextPassword string) {
	...
	v.Check(len(plaintextPassword) >= 8, "password", "must be at least 8 characters long")
	v.Check(len(plaintextPassword) <= 72, "password", "must not be more than 72 characters long")
}
